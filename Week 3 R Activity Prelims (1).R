...
nrow(women_h_w)
ncol(women_h_w)
data.frame(sapply(women_h_w,class))
...
women_weight <- women_h_w$weight
women_height <- women_h_w$height
...
women_weight_data <- data.frame(women_weight)
women_weight_data

women_height_data <- data.frame(women_height)
women_height_data
...
dim(subset(women_height_data, women_height > 65))
